(function(window, $) {
	...
	$.mockjax({
		url: '*/com.eibus.web.soap.Gateway.wcp',
		data: /GetActivityDefinition/,
		responseText: {
		   GetActivityDefinitionResponse:{
			  "caseinstanceid":"001CC42E-BB14-11E1-FA4E-3E43A945D4AF",
			  activities:{
				 "case:activity":{
					...
					"@xmlns:case":"http://schemas.cordys.com/casemanagement/1.0",
					"@xmlns":"",
					"@id":"001CC42E-BB14-11E1-FA4E-358C104134AF",
					"@name":"Activity1",
					"@type":"HUMANTASK",
					HumanInteraction:{
					   "@xmlns":"http://schemas.cordys.com/notification/workflow/1.0",
					   "HumanTaskModelId":"001CC42E-BB14-11E1-FA4E-369AF76BF4AF",
					   "Subject":"Activity1",
					   "SendTo":""
					},
					"case:messages":"",
	...
	test("Get Activity Definition", 2, function () {
        stop();
        $.cordys['case'].getActivityDefinition("001CC42E-BB14-11E1-FA4E-3E43A945D4AF", {
				beforeSend:function(xhr, settings){
					var getActivityDefinitionRequest = "<SOAP:Envelope xmlns:SOAP='http://schemas.xmlsoap.org/soap/envelope/'><SOAP:Body><GetActivityDefinition xmlns='http://schemas.cordys.com/casemanagement/execution/1.0'><caseinstanceid>001CC42E-BB14-11E1-FA4E-3E43A945D4AF</caseinstanceid><activities><activityid></activityid></activities></GetActivityDefinition></SOAP:Body></SOAP:Envelope>";
