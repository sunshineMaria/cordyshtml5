...
(function ($) {
	...
	function handleAjax(url, origSettings) {
		...
		requestSettings = jQuery.extend(true, {}, jQuery.ajaxSettings);
		ajaxExtend(requestSettings, origSettings);
		...
		for (var k = 0; k < mockHandlers.length; k++) {
			...
			(function (mockHandler, requestSettings, origSettings, origHandler) {
				var opts = ajaxExtend({}, origSettings);


				mockRequest = _ajax.call($, $.extend(false, opts, {
					// Mock the XHR object
